...
- disambiguateFIDs:
  ...
  Ignored, and will be removed in a future version. Previously was
  passed to `rgdal::readOGR()`, which is no longer used.
...
`SpatialPolygonsDataFrame` class, etc., depending on what the structure
of the GeoJSON.
