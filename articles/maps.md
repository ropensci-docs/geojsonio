...
`geojsonio` creates geojson from various inputs - and can easily feed
into tools for making maps with geojson data.
...
> Also, can do so from data.frames with polygons, lists, matrices,
> vectors, and json strings
